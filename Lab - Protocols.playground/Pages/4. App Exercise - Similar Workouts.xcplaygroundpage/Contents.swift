...
let swimWithMe = SwimmingWorkout(distance: 100, time: 45)
let runWithMe = RunningWorkout(distance: 100, time: 16)

simpleWorkoutDescription(workout: swimWithMe)
simpleWorkoutDescription(workout: runWithMe)
